...
<script type="text/javascript">
	...
	function doDelete() {
		...
		if (rows.length == 0) {
			...
			// alert(arr.toString());
			window.location.href = "../../courierAction_delete.action?ids="
					+ arr.toString();
		}
	}
...
<script type="text/javascript">
	...
	function searchCourier() {
		...
		var jsonPara = $("#searchForm").serializeJson();

		// datagrid 再次发起请求
		// load 方法: 使用一些参数查询数据。 1.json格式的参数 2.这些参数跟在url : "../../courierAction_pageQuery.action"后
		$('#grid').datagrid('load', jsonPara);
	...
	<div class="easyui-window" title="对收派员进行添加或者修改" id="addWindow" collapsible="false" minimizable="false" maximizable="false" style="top: 20px; left: 200px">
		<div region="north" style="height: 31px; overflow: hidden;" split="false" border="false">
			<div class="datagrid-toolbar">
				<a onclick="saveCourier()" id="save" icon="icon-save" href="#" class="easyui-linkbutton" plain="true">保存</a>
			</div>
		</div>
		...
		<div style="overflow: auto; padding: 5px;" border="false">
			<form id="searchForm">
				<table class="table-edit" width="80%" align="center">
					...
					<tr>
						<td colspan="2">
							<a onclick="searchCourier()" id="searchBtn" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-search'">查询</a>
						</td>
					</tr>
				</table>
			</form>
